...
class CategoryAdapter(var data: ArrayList<Category>): RecyclerView.Adapter<CategoryAdapter.MyViewHolder>() {
    lateinit var context: Context
    lateinit var firebaseFunctions: FirebaseFunctions

    class MyViewHolder(val cardViewBinding: CategoryCardViewBinding): RecyclerView.ViewHolder(cardViewBinding.root)
